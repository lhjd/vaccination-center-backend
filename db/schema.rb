...
ActiveRecord::Schema.define(version: 2021_12_29_031925) do
  ...
  create_table "day_offs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["nurse_id"], name: "index_day_offs_on_nurse_id"
  end
  ...
  create_table "nurses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["center_id"], name: "index_nurses_on_center_id"
  end
  ...
  add_foreign_key "day_offs", "nurses"
  add_foreign_key "nurses", "centers"
