...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { capacity: @slot.capacity, center_id: @slot.center_id, date: @slot.date, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { capacity: @slot.capacity, center_id: @slot.center_id, date: @slot.date, start_time: @slot.start_time } }
