...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference("Resident.count") do
      post residents_url, params: { resident: { name: @resident.name, nric: @resident.nric } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { name: @resident.name, nric: @resident.nric } }
